...
//Added method alfaLetter
    public void alfaLetter(char guessedLetter) {
        int letter = guessedLetter - 'a';
arrayAlphabet[letter] = '_';
    }
//Added Getter and setter functions
    ...
    public void startGame(int numTurns) {
        ...
        while (numGuesses <= numTurns) {
            ...
            //Now shows alfabet letter
            guessedLetter = myGuessedLetter.getGuess();
            alfaLetter(guessedLetter);
